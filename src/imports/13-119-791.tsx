import svgPaths from "./svg-dfiaqhrnhp";
  ...
  return (
    <div className="h-[27.992px] relative rounded-[6.75px] shrink-0 w-[161.528px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[27.992px] relative w-[161.528px]">
        <Icon />
        <p className="absolute font-['Poppins:Medium',sans-serif] leading-[17.5px] left-[34.98px] not-italic text-[12.25px] text-neutral-950 text-nowrap top-[5.25px] whitespace-pre">Back to Dashboard</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[22.423px] relative rounded-[6.75px] shrink-0 w-[92.677px]" data-name="Badge">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[3.5px] h-[22.423px] items-center justify-center overflow-clip px-[11.213px] py-[4.213px] relative rounded-[inherit] w-[92.677px]">
        <p className="font-['Poppins:Medium',sans-serif] leading-[14px] not-italic relative shrink-0 text-[10.5px] text-[rgba(0,212,146,0.8)] text-nowrap whitespace-pre">7-Day Report</p>
      </div>
...
function Heading() {
  return (
    <div className="absolute h-[31.501px] left-0 top-0 w-[288.881px]" data-name="Heading 1">
      <p className="absolute font-['Poppins:SemiBold',sans-serif] leading-[31.5px] left-[144.59px] not-italic text-[26.25px] text-center text-neutral-50 text-nowrap top-[1.15px] translate-x-[-50%] whitespace-pre">Incredible Progress!</p>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="absolute h-[48.99px] left-0 top-[38.5px] w-[288.881px]" data-name="Paragraph">
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[24.5px] left-[144.88px] not-italic text-[#a1a1a1] text-[15.75px] text-center top-[0.71px] translate-x-[-50%] w-[275px]">{`You've reduced phone usage while driving by`}</p>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="absolute h-[52.498px] left-0 top-[94.48px] w-[288.881px]" data-name="Container">
      <p className="absolute font-['Poppins:Bold',sans-serif] leading-[52.5px] left-[144.54px] not-italic text-[52.5px] text-[rgba(0,212,146,0.8)] text-center top-[2.31px] translate-x-[-50%] w-[108px]">78%</p>
    </div>
  );
}
...
function Text() {
  return (
    <div className="absolute h-[19.961px] left-[71.13px] top-0 w-[125.604px]" data-name="Text">
      <p className="absolute font-['Poppins:SemiBold',sans-serif] leading-[21px] left-[63px] not-italic text-[14px] text-center text-neutral-50 top-0 translate-x-[-50%] w-[126px]">156 fewer pickups</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="absolute h-[20.997px] left-0 top-[153.97px] w-[288.881px]" data-name="Paragraph">
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[21px] left-[49.28px] not-italic text-[#a1a1a1] text-[14px] text-center text-nowrap top-0 translate-x-[-50%] whitespace-pre">{`That's`}</p>
      <Text />
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[21px] left-[229.74px] not-italic text-[#a1a1a1] text-[14px] text-center top-0 translate-x-[-50%] w-[66px]">in 7 days</p>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="h-[27.992px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Poppins:Bold',sans-serif] leading-[28px] left-[43.49px] not-italic text-[21px] text-center text-neutral-50 text-nowrap top-[1.29px] translate-x-[-50%] whitespace-pre">22</p>
    </div>
  );
}
...
function Container8() {
  return (
    <div className="h-[34.999px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[17.5px] left-[43.61px] not-italic text-[#a1a1a1] text-[12.25px] text-center top-0 translate-x-[-50%] w-[62px]">Avg. Daily Reduction</p>
    </div>
  );
}
...
function Container10() {
  return (
    <div className="h-[27.992px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Poppins:Bold',sans-serif] leading-[28px] left-[43.86px] not-italic text-[21px] text-center text-neutral-50 text-nowrap top-[1.29px] translate-x-[-50%] whitespace-pre">7</p>
    </div>
  );
}
...
function Container11() {
  return (
    <div className="content-stretch flex h-[17.5px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="basis-0 font-['Poppins:Regular',sans-serif] grow leading-[17.5px] min-h-px min-w-px not-italic relative shrink-0 text-[#a1a1a1] text-[12.25px] text-center">Days Active</p>
    </div>
  );
}
...
function Container13() {
  return (
    <div className="h-[27.992px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Poppins:Bold',sans-serif] leading-[28px] left-[43.65px] not-italic text-[21px] text-[rgba(0,212,146,0.8)] text-center text-nowrap top-[1.29px] translate-x-[-50%] whitespace-pre">A+</p>
    </div>
  );
}
...
function Container14() {
  return (
    <div className="content-stretch flex h-[17.5px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="basis-0 font-['Poppins:Regular',sans-serif] grow leading-[17.5px] min-h-px min-w-px not-italic relative shrink-0 text-[#a1a1a1] text-[12.25px] text-center">Safety Grade</p>
    </div>
  );
}
      ...
      <div className="absolute inset-[8.333%]" data-name="Vector">
        <div className="absolute inset-[-5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17 17">
            <path d={svgPaths.p34cc2eb0} id="Vector" stroke="var(--stroke-0, #90A1B9)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.8" strokeWidth="1.45829" />
          </svg>
        </div>
      </div>
    </div>
...
function CardTitle() {
  return (
    <div className="absolute h-[24.495px] left-0 top-0 w-[183.572px]" data-name="CardTitle">
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[24.5px] left-0 not-italic text-[15.75px] text-neutral-50 text-nowrap top-[0.71px] whitespace-pre">Weekly Progress</p>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="absolute h-[34.999px] left-0 top-[24.5px] w-[183.572px]" data-name="Paragraph">
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[17.5px] left-0 not-italic text-[#a1a1a1] text-[12.25px] top-0 w-[184px]">Phone pickups before vs. after AI settings</p>
    </div>
  );
}
...
function Container20() {
  return (
    <div className="absolute content-stretch flex h-[17.5px] items-start left-0 top-0 w-[77.316px]" data-name="Container">
      <p className="basis-0 font-['Poppins:Regular',sans-serif] grow leading-[17.5px] min-h-px min-w-px not-italic relative shrink-0 text-[#a1a1a1] text-[12.25px] text-right">Trend</p>
    </div>
  );
}
  ...
  return (
    <div className="absolute left-0 size-[10.493px] top-[3.5px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 11">
        <g clipPath="url(#clip0_119_457)" id="Icon">
...
function Container21() {
  return (
    <div className="absolute h-[17.5px] left-0 top-[17.5px] w-[77.316px]" data-name="Container">
      <Icon4 />
      <p className="absolute font-['Poppins:Medium',sans-serif] leading-[17.5px] left-[77.99px] not-italic text-[12.25px] text-[rgba(0,212,146,0.8)] text-nowrap text-right top-0 translate-x-[-100%] whitespace-pre">Improving</p>
    </div>
  );
}
      ...
      <div className="absolute inset-[84.38%_4.95%_15.63%_24.75%]" data-name="Vector">
        <div className="absolute bottom-[-0.5px] left-0 right-0 top-[-0.5px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 213 1">
            <path d="M0 0.49999H212.996" id="Vector" opacity="0.3" stroke="var(--stroke-0, #374151)" strokeDasharray="3 3" strokeWidth="0.99998" />
          </svg>
        </div>
      </div>
    ...
    <div className="absolute contents inset-[13.39%_4.95%_15.63%_24.75%]" data-name="Group">
      <div className="absolute inset-[13.39%_70.23%_15.63%_29.77%]" data-name="Vector">
        <div className="absolute bottom-0 left-[-0.5px] right-[-0.5px] top-0">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1 159">
            <path d="M0.49999 0V158.997" id="Vector" opacity="0.3" stroke="var(--stroke-0, #374151)" strokeDasharray="3 3" strokeWidth="0.99998" />
          </svg>
        </div>
      </div>
...
function Group3() {
  return (
    <div className="absolute contents inset-[86.39%_66.1%_6.91%_25.65%]" data-name="Group">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[86.39%_66.1%_6.91%_25.65%] leading-[normal] not-italic text-[12px] text-center text-gray-400 text-nowrap whitespace-pre">Mon</p>
    </div>
  );
}
...
function Group4() {
  return (
    <div className="absolute contents inset-[86.39%_56.72%_6.91%_36.35%]" data-name="Group">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[86.39%_56.72%_6.91%_36.35%] leading-[normal] not-italic text-[12px] text-center text-gray-400 text-nowrap whitespace-pre">Tue</p>
    </div>
  );
}
...
function Group5() {
  return (
    <div className="absolute contents inset-[86.39%_45.85%_6.91%_45.57%]" data-name="Group">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[86.39%_45.85%_6.91%_45.57%] leading-[normal] not-italic text-[12px] text-center text-gray-400 text-nowrap whitespace-pre">Wed</p>
    </div>
  );
}
...
function Group6() {
  return (
    <div className="absolute contents inset-[86.39%_36.47%_6.91%_56.27%]" data-name="Group">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[86.39%_36.47%_6.91%_56.27%] leading-[normal] not-italic text-[12px] text-center text-gray-400 text-nowrap whitespace-pre">Thu</p>
    </div>
  );
}
...
function Group7() {
  return (
    <div className="absolute contents inset-[86.39%_27.58%_6.91%_67.47%]" data-name="Group">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[86.39%_27.58%_6.91%_67.47%] leading-[normal] not-italic text-[12px] text-center text-gray-400 text-nowrap whitespace-pre">Fri</p>
    </div>
  );
}
...
function Group8() {
  return (
    <div className="absolute contents inset-[86.39%_16.88%_6.91%_76.85%]" data-name="Group">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[86.39%_16.88%_6.91%_76.85%] leading-[normal] not-italic text-[12px] text-center text-gray-400 text-nowrap whitespace-pre">Sat</p>
    </div>
  );
}
...
function Group9() {
  return (
    <div className="absolute contents inset-[86.39%_6.34%_6.91%_86.4%]" data-name="Group">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[86.39%_6.34%_6.91%_86.4%] leading-[normal] not-italic text-[12px] text-center text-gray-400 text-nowrap whitespace-pre">Sun</p>
    </div>
  );
}
...
function Group12() {
  return (
    <div className="absolute contents inset-[80.92%_77.89%_12.38%_19.47%]" data-name="Group">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[80.92%_77.89%_12.38%_19.47%] leading-[normal] not-italic text-[12px] text-gray-400 text-nowrap text-right whitespace-pre">0</p>
    </div>
  );
}
...
function Group13() {
  return (
    <div className="absolute contents inset-[63.17%_77.89%_30.13%_19.47%]" data-name="Group">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[63.17%_77.89%_30.13%_19.47%] leading-[normal] not-italic text-[12px] text-gray-400 text-nowrap text-right whitespace-pre">8</p>
    </div>
  );
}
...
function Group14() {
  return (
    <div className="absolute contents inset-[45.43%_77.89%_47.88%_17.49%]" data-name="Group">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[45.43%_77.89%_47.88%_17.49%] leading-[normal] not-italic text-[12px] text-gray-400 text-nowrap text-right whitespace-pre">16</p>
    </div>
  );
}
...
function Group15() {
  return (
    <div className="absolute contents inset-[27.68%_77.89%_65.62%_17.16%]" data-name="Group">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[27.68%_77.89%_65.62%_17.16%] leading-[normal] not-italic text-[12px] text-gray-400 text-nowrap text-right whitespace-pre">24</p>
    </div>
  );
}
...
function Group16() {
  return (
    <div className="absolute contents inset-[9.94%_77.89%_83.37%_17.16%]" data-name="Group">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal inset-[9.94%_77.89%_83.37%_17.16%] leading-[normal] not-italic text-[12px] text-gray-400 text-nowrap text-right whitespace-pre">32</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[17.5px] relative shrink-0 w-[106.167px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex h-[17.5px] items-start relative w-[106.167px]">
        <p className="font-['Poppins:Regular',sans-serif] leading-[17.5px] not-italic relative shrink-0 text-[#a1a1a1] text-[12.25px] text-nowrap whitespace-pre">Before AI Settings</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="basis-0 grow h-[17.5px] min-h-px min-w-px relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex h-[17.5px] items-start relative w-full">
        <p className="font-['Poppins:Regular',sans-serif] leading-[17.5px] not-italic relative shrink-0 text-[#a1a1a1] text-[12.25px] text-nowrap whitespace-pre">After AI Settings</p>
      </div>
    </div>
  );
}
    ...
    <div className="h-[17.5px] overflow-clip relative shrink-0 w-full" data-name="Icon">
      <div className="absolute inset-[53.71%_29.17%_8.34%_29.18%]" data-name="Vector">
        <div className="absolute inset-[-10.98%_-10%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9 9">
            <path d={svgPaths.pb5dd800} id="Vector" stroke="var(--stroke-0, #FFB900)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.8" strokeWidth="1.45829" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-[41.67%] left-1/4 right-1/4 top-[8.33%]" data-name="Vector">
        <div className="absolute inset-[-8.333%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 11">
            <path d={svgPaths.p3b78ea80} id="Vector" stroke="var(--stroke-0, #FFB900)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.8" strokeWidth="1.45829" />
          </svg>
        </div>
      </div>
    </div>
...
function CardTitle1() {
  return (
    <div className="absolute h-[24.495px] left-0 top-0 w-[198.12px]" data-name="CardTitle">
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[24.5px] left-0 not-italic text-[15.75px] text-neutral-50 text-nowrap top-[0.71px] whitespace-pre">Achievements Unlocked</p>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="absolute content-stretch flex h-[17.5px] items-start left-0 top-[24.5px] w-[198.12px]" data-name="Paragraph">
      <p className="font-['Poppins:Regular',sans-serif] leading-[17.5px] not-italic relative shrink-0 text-[#a1a1a1] text-[12.25px] text-nowrap whitespace-pre">Your safety milestones this week</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[20.997px] relative shrink-0 w-[123.332px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex h-[20.997px] items-start relative w-[123.332px]">
        <p className="font-['Poppins:Medium',sans-serif] leading-[21px] not-italic relative shrink-0 text-[14px] text-neutral-50 text-nowrap whitespace-pre">Safety Champion</p>
      </div>
    </div>
  );
}
...
function Icon8() {
  return (
    <div className="relative shrink-0 size-[13.991px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_119_439)" id="Icon">
...
function Paragraph4() {
  return (
    <div className="content-stretch flex h-[17.5px] items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="font-['Poppins:Regular',sans-serif] leading-[17.5px] not-italic relative shrink-0 text-[#a1a1a1] text-[12.25px] text-nowrap whitespace-pre">78% fewer distractions while driving</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[20.997px] relative shrink-0 w-[93.245px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex h-[20.997px] items-start relative w-[93.245px]">
        <p className="font-['Poppins:Medium',sans-serif] leading-[21px] not-italic relative shrink-0 text-[14px] text-neutral-50 text-nowrap whitespace-pre">Focus Master</p>
      </div>
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="h-[34.999px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[17.5px] left-0 not-italic text-[#a1a1a1] text-[12.25px] top-0 w-[151px]">Maintained settings for 7 consecutive days</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[20.997px] relative shrink-0 w-[92.61px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex h-[20.997px] items-start relative w-[92.61px]">
        <p className="font-['Poppins:Medium',sans-serif] leading-[21px] not-italic relative shrink-0 text-[14px] text-neutral-50 text-nowrap whitespace-pre">Road Warrior</p>
      </div>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="h-[34.999px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[17.5px] left-0 not-italic text-[#a1a1a1] text-[12.25px] top-0 w-[145px]">Zero high-speed phone interactions</p>
    </div>
  );
}
      ...
      <div className="absolute inset-[8.32%_12.49%]" data-name="Vector">
        <div className="absolute inset-[-5%_-5.55%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 17">
            <path d={svgPaths.p15b1a7b0} id="Vector" stroke="var(--stroke-0, #FAFAFA)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.45829" />
          </svg>
        </div>
      </div>
    </div>
...
function CardTitle2() {
  return (
    <div className="h-[24.495px] relative shrink-0 w-full" data-name="CardTitle">
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[24.5px] left-0 not-italic text-[15.75px] text-neutral-50 text-nowrap top-[0.71px] whitespace-pre">Keep It Up!</p>
    </div>
  );
}
...
function Paragraph7() {
  return (
    <div className="content-stretch flex h-[17.5px] items-start relative shrink-0 w-full" data-name="Paragraph">
      <p className="font-['Poppins:Regular',sans-serif] leading-[17.5px] not-italic relative shrink-0 text-[#a1a1a1] text-[12.25px] text-nowrap whitespace-pre">Your AI settings are working great</p>
    </div>
  );
}
...
function Icon14() {
  return (
    <div className="relative shrink-0 size-[13.991px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_119_407)" id="Icon">
  ...
  return (
    <div className="h-[20.997px] relative shrink-0 w-[207.989px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex h-[20.997px] items-start relative w-[207.989px]">
        <p className="font-['Poppins:Medium',sans-serif] leading-[21px] not-italic relative shrink-0 text-[#ff6e06] text-[14px] text-nowrap whitespace-pre">Moderate AI Protection Active</p>
      </div>
    </div>
  );
}
...
function Paragraph8() {
  return (
    <div className="h-[52.498px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[17.5px] left-0 not-italic text-[#a1a1a1] text-[12.25px] top-0 w-[270px]">Your current settings are perfectly balanced for your driving habits. Continue to monitor your progress and adjust if needed.</p>
    </div>
  );
}
...
function Icon15() {
  return (
    <div className="relative shrink-0 size-[10.493px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 11">
        <g clipPath="url(#clip0_119_436)" id="Icon">
  ...
  return (
    <div className="h-[14.002px] relative shrink-0 w-[199.3px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[14.002px] relative w-[199.3px]">
        <p className="absolute font-['Poppins:Regular',sans-serif] leading-[14px] left-0 not-italic text-[#a1a1a1] text-[10.5px] text-nowrap top-[0.29px] whitespace-pre">Auto-activates when driving detected</p>
      </div>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="absolute bg-[rgba(69,85,108,0.8)] box-border content-stretch flex gap-[7px] h-[34.999px] items-center justify-center left-[96.13px] px-[28px] py-0 rounded-[6.75px] top-[1645.89px] w-[182.001px]" data-name="Button">
      <p className="font-['Poppins:Medium',sans-serif] leading-[17.5px] not-italic relative shrink-0 text-[12.25px] text-nowrap text-white whitespace-pre">Continue Monitoring</p>
    </div>
  );
}
...
function Text5() {
  return (
    <div className="absolute content-stretch flex h-[17.99px] items-start left-0 top-[-20000px] w-[7.575px]" data-name="Text">
      <p className="font-['Poppins:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[12px] text-neutral-950 text-nowrap whitespace-pre">8</p>
    </div>
  );
}
